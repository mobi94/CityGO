package com.android.socialnetworks.adapters;
...
import com.android.socialnetworks.fragments.FollowersFragment;
import com.android.socialnetworks.fragments.NewEventFragment;
import com.android.socialnetworks.ListItem;
import com.android.socialnetworks.ListViewHolder;
...
public class ListAdapter extends ArrayAdapter<ListItem> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (getItemViewType(position) == TYPE_ITEM) {
            ...
            holder.getImage().setImageResource(getEventIcon(Integer.parseInt(listItem.getCategory()), listItem.getCreatorName()));
    ...
    private int getEventIcon(int categoryIcon, String creatorName){
        String currentUser = ParseUser.getCurrentUser().getUsername();
        switch(categoryIcon){
            case 0:
                if (creatorName.equals(currentUser)) return R.drawable.event_love;
                else return R.drawable.event_love_else;
            case 1:
                if (creatorName.equals(currentUser)) return R.drawable.event_movie;
                else return R.drawable.event_movie_else;
            case 2:
                if (creatorName.equals(currentUser)) return R.drawable.event_sport;
                else return R.drawable.event_sport_else;
            case 3:
                if (creatorName.equals(currentUser)) return R.drawable.event_business;
                else return R.drawable.event_business_else;
            case 4:
                if (creatorName.equals(currentUser)) return R.drawable.event_coffee;
                else return R.drawable.event_coffee_else;
            case 5:
                if (creatorName.equals(currentUser)) return R.drawable.event_meet;
                else return R.drawable.event_meet_else;
            default:
                if (creatorName.equals(currentUser)) return R.drawable.event_meet;
                else return R.drawable.event_meet_else;
        }
