...
import com.android.socialnetworks.fragments.ProfileFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        parseInstallation.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                Log.d(getPackageName(), "Installation object saved " + ((e != null) ? "failed" : "successfully"));
            }
        });
    ...
    public static void disableViewPager(MyViewPager pager, PagerSlidingTabStrip tabs){
        pager.setPagingEnabled(false);
        tabs.setVisibility(View.GONE);
    }

    public static void enableViewPager(MyViewPager pager, PagerSlidingTabStrip tabs){
