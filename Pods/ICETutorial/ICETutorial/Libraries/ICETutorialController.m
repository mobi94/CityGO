...
- (void)setupView {
    ...
    [[self.leftButton layer] setCornerRadius:4];
    ...
    [[self.leftButton titleLabel] setFont:[UIFont fontWithName:@"Helvetica" size:14.0]];
...
- (void)addAllConstraints {
    ...
    NSDictionary *views = NSDictionaryOfVariableBindings(_overlayTitle, _leftButton, _pageControl, _gradientView);
    ...
    [constraints addObject:@"V:[_leftButton(==26)]-15-|"];
    [constraints addObject:@"H:[_leftButton(==40)]-15-|"];
